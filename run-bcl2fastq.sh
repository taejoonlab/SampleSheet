...
RUN_DIR="<directory of raw output>"
OUT_DIR="fastq.TKLab20200609nx"

SAMPLE_SHEET="SampleSheet-TKLab20200609nx.csv"

bcl2fastq --runfolder-dir $RUN_DIR --output-dir $OUT_DIR \
  --sample-sheet $SAMPLE_SHEET \
  --barcode-mismatch 1 --create-fastq-for-index-reads
